              ...
              <td>
                <div className='m-4 flex lg:flex-row flex-col'>
                  ...
                  <div className='mt-4 lg:mt-2 text-start text-md sm:text-xl ms-4'>
                    ...
                    <Link href="/"><button class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 focus:outline-none mt-2 w-full">Product</button></Link>
                  </div>
                </div>
              </td>
